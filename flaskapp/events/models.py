...
class Item(db.Model):
    ...
    # Many-to-many
    subitems = db.relationship('Subitem', secondary=items_subitems, backref=db.backref('items', lazy='joined'))
...
class Event(db.Model):
    ...
    guests = db.relationship('Guest', secondary=events_guests, backref=db.backref('events', lazy='joined'))

    # Many-to-many
    items = db.relationship('Item', secondary=events_items, backref=db.backref('events', lazy='joined'))
